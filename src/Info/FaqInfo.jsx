export const faqInfo = [
  {
    id: 1,
    qs: "What is a managed forex account?",
    ans: "A managed forex account is a type of currency trading account in which a professional money manager makes trades and transactions on a client's behalf for a fee. Individual investors who are not experts in foreign currencies but still want exposure to this asset class may consider a managed forex account. Managed forex accounts are also often chosen as sub-advised funds for money managers who want a currencies component to their portfolio but who do not specialize in foreign exchange (FX) trading. Managed forex accounts offer exposure to an asset class much different than stocks or bonds. However, managed forex accounts are high-risk, high-reward investments",
  },
  {
    id: 2,
